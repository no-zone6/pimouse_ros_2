...
from pimouse_ros_2.srv import TimedMotion
...
class MotorTest(unittest.TestCase):
  ...
  def test_put_cmd_vel(self):
    ...
    self.file_check("rtmotor_raw_r0",600,"wrong right value from cml_vel")
...
if __name__ == '__main__':
  ...
  rostest.rosrun('pimouse_ros_2','travis_test_motors', MotorTest)
